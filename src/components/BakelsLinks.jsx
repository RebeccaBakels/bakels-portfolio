  ...
  return (
    <>
      <div className="button-group">
        <Button
          style={{ backgroundColor: "#ffde59", marginTop: "10px" }}
          size="large"
          variant="contained"
        ...
        <Button
          style={{ backgroundColor: "#ff9659", marginTop: "10px" }}
          size="large"
          variant="contained"
          href="https://www.linkedin.com/in/rebecca-bakels-311920139/"
        >
          LinkedIn
        </Button>
        <Button
          style={{ backgroundColor: "#ff6859", marginTop: "10px" }}
          size="large"
          variant="contained"
